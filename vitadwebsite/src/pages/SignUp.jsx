...
export default function SignUp() {
  ...
  const handleGoogle = async () => {
    try { await signInWithGoogle(); } catch (err) { toast.error(err.message); }
  };
    ...
    <div className="auth-body">
      ...
      <div className="auth-container">
        <div className="auth-logo">
          <svg className="logo-icon-svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#0058BC" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2v20" />
        ...
        <div className="auth-card">
          ...
          <p className="auth-subtitle">Start your Vitamin D diagnostic journey today.</p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="field-group">
              ...
              <div className="input-wrapper">
                ...
                <input id="fullName" type="text" className="field-input" placeholder="Your full name"
            ...
            <div className="field-group">
              ...
              <div className="input-wrapper">
                ...
                <input id="email" type="email" className="field-input" placeholder="name@example.com"
            ...
            <div className="field-group">
              ...
              <div className="input-wrapper">
                <span className="input-icon">🔒</span>
                <input id="password" type={showPw ? 'text' : 'password'} className="field-input" placeholder="Min 6 characters"
