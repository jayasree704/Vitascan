...
class RecommendationService {
  ...
  static const Map<String, List<RecommendedFood>> _foods = {
    'Deficient': [
      RecommendedFood(
        name: 'Wild Salmon & Mackerel',
        description:
            'The richest natural source of Vitamin D3 — a 100 g serving covers most of a daily requirement.',
        category: 'Seafood',
      ),
      RecommendedFood(
        name: 'Cod Liver Oil',
        description:
            'One teaspoon delivers a large D3 dose; useful while levels are being corrected.',
        category: 'Supplement Food',
      ),
      RecommendedFood(
        name: 'Fortified Milk & Cereals',
        description:
            'Provides a steady daily intake of Vitamin D2/D3 alongside calcium.',
        category: 'Fortified Foods',
      ),
      RecommendedFood(
        name: 'Egg Yolks',
        description:
            'Moderate Vitamin D, highest in eggs from pasture-raised hens.',
        category: 'Dairy & Eggs',
      ),
    ],
    'Insufficient': [
      RecommendedFood(
        name: 'Fatty Fish',
        description:
            'Salmon, sardines and mackerel twice a week lift levels reliably.',
        category: 'Seafood',
      ),
      RecommendedFood(
        name: 'UV-Exposed Mushrooms',
        description:
            'Natural plant-based source of Vitamin D2 — good for vegetarian diets.',
        category: 'Vegetables',
      ),
      RecommendedFood(
        name: 'Fortified Milk & Cereals',
        description:
            'A dependable daily top-up when sunlight exposure is limited.',
        category: 'Fortified Foods',
      ),
      RecommendedFood(
        name: 'Egg Yolks',
        description:
            'Easy everyday addition that also supplies healthy fats for absorption.',
        category: 'Dairy & Eggs',
      ),
    ],
    'Sufficient': [
      RecommendedFood(
        name: 'Oily Fish',
        description:
            'Keep one or two portions a week to hold your level in the healthy range.',
        category: 'Seafood',
      ),
      RecommendedFood(
        name: 'Egg Yolks',
        description: 'A simple maintenance source of Vitamin D3.',
        category: 'Dairy & Eggs',
      ),
      RecommendedFood(
        name: 'UV-Exposed Mushrooms',
        description: 'Adds Vitamin D2 without changing your routine.',
        category: 'Vegetables',
      ),
      RecommendedFood(
        name: 'Fortified Yoghurt',
        description:
            'Supports calcium absorption, which depends on adequate Vitamin D.',
        category: 'Fortified Foods',
      ),
    ],
  };
  ...
  static List<RecommendedFood> foodsFor(String status) =>
      _foods[status] ?? _foods['Insufficient']!;

  static List<String> tipsFor(String status) =>
      _tips[status] ?? _tips['Insufficient']!;
}
