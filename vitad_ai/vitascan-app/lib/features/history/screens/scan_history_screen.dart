...
class _HistoryCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final patientName = (record.patientName != null && record.patientName!.trim().isNotEmpty)
    ...
    final displayMeta = metaStr.isNotEmpty ? metaStr : 'Vitamin D Analysis';
    final statusText = record.status.isNotEmpty ? record.status : 'Analyzed';
