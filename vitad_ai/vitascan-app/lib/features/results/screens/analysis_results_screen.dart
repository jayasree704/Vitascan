...
/// Shows how deeply the test line developed — the kit is graded by that shade.
class _ShadeRow extends StatelessWidget {
  final String status;
  const _ShadeRow({required this.status});

  @override
  Widget build(BuildContext context) {
    final shade = shadeForStatus(status);
    final swatch = Color(int.parse(shade.hex.substring(1), radix: 16) | 0xFF000000);
